...
<div class="itemcard">
    <section id="packages">
        ...
        <div class="headingp" style="padding-top: 100px;">
          <h2><samp style="color:#27ae60;"><?php echo $_GET['category_name']; ?></samp> CATEGORY</h2>
          <p>Incredible deals available for a limited time only. Don't miss out!</p>
        </div>
        ...
        <div class="team-row-item">
          ...
          <?php
          $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE cat_id=$cat_id");
